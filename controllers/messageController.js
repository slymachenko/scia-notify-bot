module.exports = (source, options) => {
  ...
  switch (source) {
    ...
    case "/admin":
      response = {
        add: `Вы успешно стали администратором. Чтобы ознакомиться с новыми возможностями, воспользуйся командой /help`,
    ...
    case "event":
      response = {
        responses: [
          ...
          "Как делишки?) Я просто хотел напомнить что тут совсем чуток осталось до крутезного ивента)",
        ],
